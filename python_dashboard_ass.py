...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Dashboard", style={'textAlign': 'center', 'color': '#503D36', 'font-size': 40}),
...
def update_output_container(selected_statistics, input_year):
    ...
    # Yearly Statistics Report Plots
        ...
        # Plot 3: Average vehicles sold by vehicle type during the selected year
